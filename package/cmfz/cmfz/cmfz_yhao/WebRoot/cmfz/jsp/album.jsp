...
<html>
		...
		<script type="text/javascript">
			$(function(){
				...
				$("#albumlTable").treegrid({
					...
					idField:"id",    
    				treeField:"title",
    				onDblClickRow:function(index,row){//展示详情的双击行事件
    					album = $("#albumlTable").treegrid("getSelected").id;
				...
				$("#albumSave").linkbutton({
					onClick:function(){
    					...
    					url = "${pageContext.request.contextPath}/Chapter/download?fileName="+row.title;
	...
	<body>
		<table id="albumlTable">
			<thead>
				<tr>
					<th  data-options="field:'title',width:'4'">名字</th>
					<th data-options="field:'downloadPath',width:'3'">下载路径</th>
					<th data-options="field:'size',width:'1'">章节大小</th>
					<th data-options="field:'duration',width:'1'">章节时长</th>
				</tr>
			</thead>
		</table>
