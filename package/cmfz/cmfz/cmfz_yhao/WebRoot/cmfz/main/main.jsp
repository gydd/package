		...
		$.ajax({
			...
			success:function(data){
				$.each(data,function(index,first){
					var content="";
				$.each(first.menu,function(index,second){
					content+="<p align=center'><a href='#' onclick=\"addTabs(\'"+second.title+"\',\'"+second.href+"\',\'"+second.iconcls+"\')\" class='easyui-linkbutton' data-options=\"iconCls:'icon-add'\">"+second.title+"</a></p>";
